...
public class TeaEncryption implements Encryption {
    ...
    public void decrypt64(byte[] text, int offset,Key key){
        int a = byteToInt(text,offset);
        int b = byteToInt(text,offset+4);
